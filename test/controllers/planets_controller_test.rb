...
class PlanetsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create planet" do
    assert_difference('Planet.count') do
      post planets_url, params: { planet: { galaxia: @planet.galaxia, nombre: @planet.nombre, tamaño: @planet.tamaño } }
    end
  ...
  test "should update planet" do
    patch planet_url(@planet), params: { planet: { galaxia: @planet.galaxia, nombre: @planet.nombre, tamaño: @planet.tamaño } }
